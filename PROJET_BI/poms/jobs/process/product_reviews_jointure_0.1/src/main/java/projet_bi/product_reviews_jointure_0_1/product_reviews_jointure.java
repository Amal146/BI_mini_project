...
package projet_bi.product_reviews_jointure_0_1;
...
/**
 * Job: product_reviews_jointure Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class product_reviews_jointure implements TalendJob {
	...
	private final String jobName = "product_reviews_jointure";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					product_reviews_jointure.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(product_reviews_jointure.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class products_reviewsStruct implements routines.system.IPersistableRow<products_reviewsStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_product_reviews_jointure = new byte[0];
		static byte[] commonByteArray_PROJET_BI_product_reviews_jointure = new byte[0];
		...
		public String _product_category_name_1;

		public String get_product_category_name_1() {
			return this._product_category_name_1;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final products_reviewsStruct other = (products_reviewsStruct) obj;
		...
		public void copyDataTo(products_reviewsStruct other) {

			other._product_id = this._product_id;
			other._review_score = this._review_score;
			other._seller_id = this._seller_id;
			other._product_category_name_1 = this._product_category_name_1;
			other._product_name_lenght = this._product_name_lenght;

		}

		public void copyKeysDataTo(products_reviewsStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_product_reviews_jointure.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_product_reviews_jointure.length == 0) {
						commonByteArray_PROJET_BI_product_reviews_jointure = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_product_reviews_jointure = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_product_reviews_jointure, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_product_reviews_jointure, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_product_reviews_jointure, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_product_reviews_jointure, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_product_reviews_jointure) {
				...
				try {
					...
					this._product_category_name_1 = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this._product_category_name_1, dos);
		...
		public String toString() {
			...
			sb.append(",_product_category_name_1=" + _product_category_name_1);
		 ...
		 * Compare keys
		 */
		public int compareTo(products_reviewsStruct other) {
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				products_reviewsStruct products_reviews = new products_reviewsStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "products_reviews");
				}
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/adelj/TOS_BD-20211109_1610-V8.0.1/workspace/p_products_reviews.csv"))
...
// # Outputs initialization
				products_reviewsStruct products_reviews_tmp = new products_reviewsStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "C:/Users/adelj/Desktop/dataset/olist_products_dataset.csv";
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							row1._product_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							row1._product_category_name = fid_tFileInputDelimited_3
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_name_lenght = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											...
											"_product_name_lenght", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_name_lenght = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_description_lenght = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_description_lenght", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_description_lenght = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_photos_qty = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_photos_qty", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_photos_qty = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_weight_g = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_weight_g", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_weight_g = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_length_cm = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_length_cm", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_length_cm = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_height_cm = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_height_cm", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_height_cm = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1._product_width_cm = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_product_width_cm", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row1._product_width_cm = null;
						...
						if (row1 != null) {
							...
							while ((tHash_Lookup_row2 != null && tHash_Lookup_row2.hasNext()) || forceLooprow2) { // G_TM_M_043
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey._product_id = row1._product_id;
								...
								if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									// and it contains more one result from keys : row3._product_id = '" +
									// row3HashKey._product_id + "'");
								} // G 071
...
// # Output table : 'products_reviews'
// # Filter conditions 
									if (

									row2._order_id == row3._order_id

									) {
										products_reviews_tmp._product_id = row1._product_id;
										products_reviews_tmp._review_score = row2._review_score;
										products_reviews_tmp._seller_id = row3._seller_id;
										products_reviews_tmp._product_category_name_1 = row1._product_category_name;
										products_reviews_tmp._product_name_lenght = row1._product_name_lenght;
										products_reviews = products_reviews_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "products_reviews"
								if (products_reviews != null) {
									...
									if (products_reviews._product_id != null) {
										sb_tFileOutputDelimited_1.append(products_reviews._product_id);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (products_reviews._review_score != null) {
										sb_tFileOutputDelimited_1.append(products_reviews._review_score);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (products_reviews._seller_id != null) {
										sb_tFileOutputDelimited_1.append(products_reviews._seller_id);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (products_reviews._product_category_name_1 != null) {
										sb_tFileOutputDelimited_1.append(products_reviews._product_category_name_1);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (products_reviews._product_name_lenght != null) {
										sb_tFileOutputDelimited_1.append(products_reviews._product_name_lenght);
									}
								...
								} // End of branch "products_reviews"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "products_reviews");
				}
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this._order_id = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this._order_id = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this._order_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this._order_id, dos, objectOut);
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row3,row2) outputs:(products_reviews)
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/adelj/Desktop/dataset/olist_order_items_dataset.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row3._order_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_order_item_id", "row3", temp, ex_tFileInputDelimited_1),
							...
							row3._product_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row3._seller_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_shipping_limit_date", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_price", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"_freight_value", "row3", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final product_reviews_jointure product_reviews_jointureClass = new product_reviews_jointure();

		int exitCode = product_reviews_jointureClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = product_reviews_jointure.class.getClassLoader().getResourceAsStream(
					"projet_bi/product_reviews_jointure_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = product_reviews_jointure.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : product_reviews_jointure");
		}
...
/************************************************************************************************
 * 134887 characters generated by Talend Open Studio for Big Data on the 16
 * janvier 2024, 5:12:30 PM CET
 ************************************************************************************************/